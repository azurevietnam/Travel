                                    ...
                                    <div class="chart-data-selector" id="salesSelectorWrapper">
                                        ...
                                        <div id="salesSelectorItems" class="chart-data-selector-items mt-sm">
                                            ...
                                            <script>
                                                ...
                                                // See: <?php echo base_url()?>admin/javascripts/dashboard/examples.dashboard.js for more settings.
                                ...
                                <header class="panel-heading bg-primary">
                                    ...
                                    <div class="widget-profile-info">
                                        <div class="profile-picture">
                                            <img src="<?php echo base_url()?>admin/images/!logged-user.jpg">
                                        </div>
                                        ...
                                        <li>
                                            <div class="tm-box">
                                                ...
                                                <div class="thumbnail-gallery">
                                                    <a class="img-thumbnail lightbox" href="<?php echo base_url()?>admin/images/projects/project-4.jpg" data-plugin-options='{ "type":"image" }'>
                                                        <img class="img-responsive" width="215" src="<?php echo base_url()?>admin/images/projects/project-4.jpg">
																<span class="zoom">
