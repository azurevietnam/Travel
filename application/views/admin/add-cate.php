                ...
                <form class="form-horizontal form-bordered" id="postForm" action="<?php echo base_url('Category/insertCate/')?>" method="post" onsubmit="" enctype="multipart/form-data">
                    <div class="row">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-2">
                                <input type="text" data-plugin-colorpicker class="colorpicker-rgba form-control" value="" data-horizontal="true" name="color_cd" id="color_cd"/>
                            </div>
                            <label class="col-md-2 control-label">Màu Tiêu Đề</label>
                            <div class="col-md-2">
                                <input type="text" data-plugin-colorpicker class="colorpicker-rgba form-control" value="" data-horizontal="true" name="title_color_cd" id="title_color_cd"/>
                            </div>
                            <label class="col-md-2 control-label">Màu Nội Dung</label>
                            <div class="col-md-2">
                                <input type="text" data-plugin-colorpicker class="colorpicker-rgba form-control" value="" data-horizontal="true" name="font_color_cd" id="font_color_cd"/>
                            </div>
                        </div>
                        <div class="form-group">
